  ...
  return (
    <>
      {paths.some(
        ...
        <footer className="w-full bg-[#0e0e0e] text-white rounded-t-[60px] lg:px-16 px-8 lg:py-12 py-7 mt-4">
          <div className="w-full">
            <div className="w-full lg:flex-row flex flex-col items-start py-16 border-b border-b-[#5b5b5b]">
              <div className="lg:w-[30%] w-full lg:mr-16">
                <div className="lg:w-10/12 w-full lg:mb-0 mb-8">
                  <h1 className="lg:text-3xl text-xl mb-4">RUKS Á LA MODE</h1>
                  ...
                  <p className="opacity-60 leading-relaxed lg:text-base text-sm">
              ...
              <div className="lg:w-[36%] w-3/4 flex items-start justify-between mr-10 text-lg lg:mb-0 mb-8">
                <div className="lg:w-1/2 ">
                  {menu.map((m) => (
                    <Link key={m} href={`/${m}`}>
                      <p className="capitalize mb-3 opacity-70 lg:text-base text-sm">
                        {m.replace("-", " ")}
                      </p>
                    </Link>
                  ))}
            ...
            <div className="mt-8">
              <p className="opacity-60 lg:text-base text-xs">
